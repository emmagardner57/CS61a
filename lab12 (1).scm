...
(define (closer-city lat lon city-a city-b)
  (define city-c (make-city 'city-c lat lon))
  (if(> (distance city-c city-a) (distance city-c city-b))
  (get-name city-b)
  (get-name city-a)))
...
(define (teacher-hold-class teacher)
  ...
  (map (lambda (x) (student-attend-class x (teacher-get-class teacher))) (teacher-get-students teacher))))
